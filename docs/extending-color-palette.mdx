...
The full list of available colors can be found [here](https://github.com/FormidableLabs/react-native-zephyr/blob/master/packages/core/src/handlers/twColors.ts) and viewed below.

<!-- Can pass `colors` array prop to component to display an abridged list of colors -->
